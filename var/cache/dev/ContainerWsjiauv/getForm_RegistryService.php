...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\RegistrationFormType' => function () {
    return ${($_ = isset($this->services['app.form.registration']) ? $this->services['app.form.registration'] : ($this->services['app.form.registration'] = new \AppBundle\Form\RegistrationFormType())) && false ?: '_'};
